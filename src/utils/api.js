...
export const videoSources = [
  ...
  { name: '星辰影视', url: 'https://api.xingchenzy.com/api.php/provide/vod/', isAvailable: true, priority: 7 },
  { name: '天空影视', url: 'https://api.tiankongzy.com/api.php/provide/vod/', isAvailable: true, priority: 8 },
  { name: '银河影视', url: 'https://api.yinhezy.com/api.php/provide/vod/', isAvailable: true, priority: 9 },
  { name: '宇宙影视', url: 'https://api.yuzhouzy.com/api.php/provide/vod/', isAvailable: true, priority: 10 }
];
